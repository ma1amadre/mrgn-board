...
голосованием, история изменений, чек-листы, вложения и @упоминания в задачах, команда и роли.
SPA на Vite + React, данные в Supabase (Postgres + Auth + RLS + Realtime), хостинг — GitHub Pages.
